            ...
            <div className="rounded-lg p-6" style={{ backgroundColor: 'var(--card-bg)', border: '1px solid var(--border-color)' }}>
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button 
                  ...
                  style={{
                    borderColor: theme === 'light' ? '#21c063' : 'var(--border-color)',
                    backgroundColor: theme === 'light' ? 'rgba(0, 118, 76, 0.05)' : 'var(--card-bg)'
                  }}
                >
                  <Sun className="w-5 h-5" style={{ color: theme === 'light' ? '#21c063' : 'var(--muted-fg)' }} />
                  <span className="text-sm font-medium" style={{ color: theme === 'light' ? '#21c063' : 'var(--fg)' }}>
                    Light
                  </span>
                </button>
                ...
                <button 
                  ...
                  className="flex flex-col items-center gap-2 px-8 py-4 rounded-lg border transition-all"
                  style={{
                    borderColor: theme === 'dark' ? '#21c063' : 'var(--border-color)',
                    backgroundColor: theme === 'dark' ? 'rgba(0, 118, 76, 0.05)' : 'var(--card-bg)'
                  }}
                >
                  <Moon className="w-5 h-5" style={{ color: theme === 'dark' ? '#21c063' : 'var(--muted-fg)' }} />
                  <span className="text-sm font-medium" style={{ color: theme === 'dark' ? '#21c063' : 'var(--fg)' }}>
                    Dark
                  </span>
                </button>
                ...
                <button 
                  ...
                  className="flex flex-col items-center gap-2 px-8 py-4 rounded-lg border transition-all"
                  style={{
                    borderColor: theme === 'system' ? '#21c063' : 'var(--border-color)',
                    backgroundColor: theme === 'system' ? 'rgba(0, 118, 76, 0.05)' : 'var(--card-bg)'
                  }}
                >
                  <Monitor className="w-5 h-5" style={{ color: theme === 'system' ? '#21c063' : 'var(--muted-fg)' }} />
                  <span className="text-sm font-medium" style={{ color: theme === 'system' ? '#21c063' : 'var(--fg)' }}>
                    System
                  </span>
                </button>
              </div>
          ...
          <div className="pt-8" style={{ borderTop: '1px solid var(--border-color)' }}>
            ...
            <div className="rounded-lg p-6" style={{ backgroundColor: 'rgba(0, 118, 76, 0.05)', border: '1px solid rgba(0, 118, 76, 0.2)' }}>
              <p className="flex items-center gap-2" style={{ color: 'var(--muted-fg)' }}>
                <Settings className="w-5 h-5" style={{ color: '#21c063' }} />
