          ...
          <div className="mb-12">
            ...
            <div className="rounded-lg p-6" style={{ backgroundColor: 'var(--card-bg)', border: '1px solid var(--border-color)' }}>
              ...
              <div className="flex gap-3 mt-4">
                ...
                >
                  <Sun className="w-5 h-5" style={{ color: theme === 'light' ? '#188e49' : 'var(--muted-fg)' }} />
                  <span className="text-sm font-medium" style={{ color: theme === 'light' ? '#188e49' : 'var(--fg)' }}>
                    Light
                  </span>
                </button>
                ...
                >
                  <Moon className="w-5 h-5" style={{ color: theme === 'dark' ? '#188e49' : 'var(--muted-fg)' }} />
                  <span className="text-sm font-medium" style={{ color: theme === 'dark' ? '#188e49' : 'var(--fg)' }}>
                    Dark
                  </span>
                </button>
                ...
                >
                  <Monitor className="w-5 h-5" style={{ color: theme === 'system' ? '#188e49' : 'var(--muted-fg)' }} />
                  <span className="text-sm font-medium" style={{ color: theme === 'system' ? '#188e49' : 'var(--fg)' }}>
                    System
                  </span>
                </button>
              </div>
